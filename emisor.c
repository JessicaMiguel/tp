...
int main(int argc, char **argv) {
    ...
    char *iface = "ens3";//"wlp1s0";//"virbr0";//"enp2s0";//"wlp3s0"; // 2 Nombre de la interface de red
    unsigned char MAC_destino[ETH_ALEN] // Cargo valores MAC destino
        = {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF };//{0x0c,0xcd,0x5c,0x42,0x57,0x00};//{0xFF,0xFF,0xFF,0xFF,0xFF,0xFF };//0x01, 0x00, 0x5E, 0x01,0x01,0x01};////0x28,0x39,0x26,0xd5,0x86,0x1d/*0x52,0x54,0x00,0x6a,0x95,0x20/*0x01, 0x00, 0x5E, 0x00,0x00,0x00/*0xFF,0xFF,0xFF,0xFF,0xFF,0xFF/* 0x52,0x54,0x00,0x6a,0x95,0x20/*0xF4, 0x8E, 0x38, 0xF6, 0xA5, 0xEB/*0x14, 0xDD, 0xA9, 0x02, 0xC9, 0x3C/*0xF4, 0x8E, 0x38, 0xF6, 0xA5, 0xEB/0x50, 0x7B, 0x9D, 0x7A, 0x2E, 0x56/0xF4, 0x6D, 0x04, 0xCD, 0xC8, 0x09/*0x48, 0xE2, 0x44, 0x81, 0xA6, 0xDF/*0x14, 0xDD, 0xA9, 0x02, 0xC9, 0x3C/*0x48, 0xE2, 0x44, 0x81, 0xA6, 0xDF/*0xEC, 0xA8, 0x6B, 0x52, 0x12, 0xD8/0x24, 0x0A, 0x64, 0x0F, 0x74, 0x2A*//*0x48, 0xE2, 0x44, 0x81, 0xA6, 0xDF*/ };
    unsigned short proto = 0x0800; // Campo de protocolo de 16 bits
